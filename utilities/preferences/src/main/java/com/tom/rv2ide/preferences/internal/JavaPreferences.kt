...
object JavaPreferences {
  ...
  var isJavaKotlinRecognitionEnabled: Boolean
    get() = prefManager.getBoolean(JAVA_KOTLIN_RECOGNITION_ENABLED, false)
    set(value) {
      prefManager.putBoolean(JAVA_KOTLIN_RECOGNITION_ENABLED, value)
    }
