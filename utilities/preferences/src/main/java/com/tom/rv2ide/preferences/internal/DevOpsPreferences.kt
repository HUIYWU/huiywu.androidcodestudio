...
object DevOpsPreferences {
  ...
  const val KEY_DEVOPTS_DEBUGGING_IDE_DEBUG_LOGS = "${KEY_DEVOPTS_DEBUGGING}.ideDebugLogs"
  ...
  var ideDebugLogsEnabled: Boolean
    get() = prefManager.getBoolean(KEY_DEVOPTS_DEBUGGING_IDE_DEBUG_LOGS, false)
    set(value) {
      prefManager.putBoolean(KEY_DEVOPTS_DEBUGGING_IDE_DEBUG_LOGS, value)
    }
}
