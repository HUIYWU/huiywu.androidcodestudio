...
class ChangesFragment : Fragment() {
    ...
    private fun showCommitDialog() {
        ...
        MaterialAlertDialogBuilder(requireContext())
            .setTitle(R.string.git_commit_changes_title)
            .setView(dialogView)
            .setPositiveButton(R.string.git_commit) { _, _ ->
    ...
    private fun showDiscardConfirmation(filePath: String) {
        MaterialAlertDialogBuilder(requireContext())
            .setTitle(R.string.git_discard_changes_title)
            .setMessage(getString(R.string.git_discard_changes_message, filePath))
            .setPositiveButton(R.string.git_discard) { _, _ ->
