...
class AIPermissionDialog(private val context: Context) {
    ...
    fun showFileWriteConfirmation(
        ...
        MaterialAlertDialogBuilder(context)
            .setTitle(R.string.ai_file_write_permission_title)
            .setMessage(context.getString(R.string.ai_file_write_permission_message, fileName))
            .setPositiveButton(R.string.ai_allow) { dialog, _ ->
                onConfirm()
                dialog.dismiss()
            }
            .setNegativeButton(R.string.ai_deny) { dialog, _ ->
                onDeny()
                dialog.dismiss()
            }
            .setNeutralButton(R.string.ai_always_allow) { dialog, _ ->
    ...
    fun showPermissionSettings(onSettingsChanged: () -> Unit) {
        ...
        MaterialAlertDialogBuilder(context)
            .setTitle(R.string.ai_permissions_title)
            .setView(view)
