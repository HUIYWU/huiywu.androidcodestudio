...
class SettingsFragment : Fragment() {
    ...
    private fun loadSettings() {
        ...
        binding.textCredentialsStatus.text = getString(if (hasCredentials) R.string.status_saved else R.string.not_saved)
    }
    ...
    private fun setupButtons() {
        ...
        binding.switchRememberCredentials.setOnCheckedChangeListener { _, isChecked ->
            ...
            if (!isChecked) {
                ...
                binding.textCredentialsStatus.text = getString(R.string.not_saved)
            }
        }
        
        binding.buttonClearCredentials.setOnClickListener {
            MaterialAlertDialogBuilder(requireContext())
                .setTitle(R.string.git_clear_credentials_title)
                .setMessage(R.string.git_clear_credentials_message)
                .setPositiveButton(R.string.git_clear) { _, _ ->
                    prefsManager.clearCredentials()
                    binding.textCredentialsStatus.text = getString(R.string.not_saved)
    ...
    private fun showEditUserConfigDialog() {
        ...
        MaterialAlertDialogBuilder(requireContext())
            .setTitle(R.string.git_user_config_title)
            .setView(dialogView)
