...
open class CompletionItem(
  ...
  companion object {
    ...
    private val log = LoggerFactory.getLogger(CompletionItem::class.java)
    ...
    try {
      if (IdeLogConfig.shouldLogInfo()) {
        log.info(
            ...
            completionKind,
            command?.command,
            additionalTextEdits?.size ?: 0,
            additionalEditHandler?.javaClass?.name,
      ...
      log.error(
          "CompletionItem.performCompletion(position) failed: label='{}', insertText='{}', format={}, line={}, column={}, index={}, kind={}, command={}, additionalTextEditsCount={}, additionalEditHandler={}, editorClass={}",
          ideLabel,
          insertText,
          insertTextFormat,
          position.line,
  ...
  override fun performCompletion(editor: CodeEditor, text: Content, line: Int, column: Int) {
    try {
      ...
      editHandler.performEdits(this, editor, text, line, column, index)
    } catch (t: Throwable) {
      log.error(
          "CompletionItem.performCompletion(line,column) failed: label='{}', insertText='{}', format={}, line={}, column={}, kind={}, command={}, additionalTextEditsCount={}, additionalEditHandler={}, editorClass={}",
          ideLabel,
          insertText,
          insertTextFormat,
          line,
