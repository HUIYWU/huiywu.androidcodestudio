...
/** Starts XML LSP references lookup from the editor code-actions menu. */
internal class FindReferencesAction : EditorActionItem {
  override val id: String = "ide.editor.lsp.xml.findReferences"
  ...
  override fun prepare(data: ActionData) {
    ...
    label = context.getString(R.string.action_find_references)
